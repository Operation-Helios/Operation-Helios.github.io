...
function openBox(element) {
	...
	newBox.children('iframe').on('load', function (e) {
		...
		var code = '<div id=\'disqus_thread\'></div><script type=\'text/javascript\'>var disqus_shortname=\''
		+shortname+'\';var disqus_identifier=\''+id+'\';var disqus_title=\''+title+'\';var disqus_url=\''
		+url+'\';(function(){var dsq = document.createElement(\'script\'); dsq.type = \'text/javascript\';'
		...
		+'comments powered by Disqus.</a></noscript><a href=\'http://disqus.com\' class=\'dsq-brlink\'>comments powered by '
		+'<span class=\'logo-disqus\'>Disqus</span></a>';
		newBox.children('iframe').contents().find('.container').html(code);
